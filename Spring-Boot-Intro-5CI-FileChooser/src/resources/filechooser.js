/**
 * Dieses Attribut kennzeichnet einen Behälter (z.B. <div>) für drei (optionale)
 * klickbare Elemente (z.B. <button>), die folgende Wirkungen haben:
  ...
  return {
    ...
    link: function(scope, elem, attrs, ngModel) {
      ...
      angular.forEach(elem[0].querySelectorAll("[file-download]"),
          function(el) {
            var
              attr = el.getAttribute("file-download");
